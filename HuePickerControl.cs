  ...
  public class HuePickerControl : UserControl
  {
    ...
    public HuePickerControl()
    {
      ...
      lock (HuePickerControl.__ENCList)
        HuePickerControl.__ENCList.Add(new WeakReference((object) this));
    ...
    private void HuePickerControl_Load(object sender, EventArgs e)
    {
      ...
      foreach (Hue hue in Hues.List)
      {
        if (hue.Index == this.mHue.Index)
          this.lstHue.SelectedIndex = this.lstHue.Items.Add((object) hue);
        else
          this.lstHue.Items.Add((object) hue);
      }
    ...
    private void InitializeComponent()
    {
      ...
      this.cboQuick.Items.AddRange(new object[19]
      {
        ...
        (object) "Skin",
        (object) "Hair",
        (object) "Interesting #1",
        (object) "Pinks",
        (object) "Elemental Weapons",
        (object) "Interesting #2",
        (object) "Blues",
        (object) "Elemental Wear",
        (object) "Greens",
        (object) "Oranges",
        (object) "Reds",
        (object) "Yellows",
      ...
      this.ToolTip1.SetToolTip((Control) this.cboQuick, "Bookmarks");
      this.Controls.Add((Control) this.cboQuick);
      this.Controls.Add((Control) this.StatusBar);
      this.Controls.Add((Control) this.lstHue);
