...
namespace GumpStudio.Elements
{
  ...
  public abstract class BaseElement : ISerializable, ICloneable
  {
    ...
    public virtual Rectangle Bounds
    {
      get
      {
        return new Rectangle(this.mLocation, this.mSize);
      }
    }
    ...
    public int Z
    {
      get
      {
        return this.mParent.mElements.IndexOf((object) this);
      }
      set
      {
        this.mParent.mElements.Remove((object) this);
        this.mParent.mElements.Insert(value, (object) this);
      }
    }
    ...
    {
      long num1;
      if (BaseElement.mIDs.Contains((object) this.Type))
      {
        long num2 = Conversions.ToLong(BaseElement.mIDs[(object) this.Type]) + 1L;
        BaseElement.mIDs[(object) this.Type] = (object) num2;
        num1 = num2;
      }
      else
      {
        BaseElement.mIDs.Add((object) this.Type, (object) 1);
        num1 = 1L;
      }
    ...
    public void AddExtender(ElementExtender Extender)
    {
      ...
      if (BaseElement.mExtenders.Contains((object) Extender))
        return;
      BaseElement.mExtenders.Add((object) Extender);
    }
      ...
      try
      {
        foreach (object selectedElement in this.mParent.GetSelectedElements())
        {
          ...
          if (objectValue != this)
          {
            ...
            baseElement.X = (int) Math.Round((double) this.X + (double) this.Width / 2.0 - (double) baseElement.Width / 2.0);
          }
        }
      }
      finally
    ...
    protected virtual void DoAlignMiddlesMenu(object sender, EventArgs e)
    {
      ...
      try
      {
        foreach (object selectedElement in this.mParent.GetSelectedElements())
        {
          ...
          {
            BaseElement baseElement = (BaseElement) objectValue;
            baseElement.Y = (int) Math.Round((double) this.Y + (double) this.Height / 2.0 - (double) baseElement.Height / 2.0);
          }
        }
      }
      finally
    ...
    protected virtual void DoHorizontalSpacingMenu(object sender, EventArgs e)
    {
      ...
      arrayList.Sort((IComparer) new BaseElement.ElementHorizontalSorter());
      double num4 = (double) (num1 - num2) / (double) (arrayList.Count - 1);
      ...
      try
      {
        foreach (object obj in arrayList)
        {
          ...
          objectValue.X = (int) Math.Round(num5 - (double) objectValue.Width / 2.0);
          num5 += num4;
        }
      }
      finally
    ...
    protected virtual void DoVerticalSpacingMenu(object sender, EventArgs e)
    {
      ...
      arrayList.Sort((IComparer) new BaseElement.ElementVerticalSorter());
      double num4 = (double) (num1 - num2) / (double) (arrayList.Count - 1);
      double num5 = (double) num2;
      try
      {
        ...
        {
          BaseElement objectValue = (BaseElement) RuntimeHelpers.GetObjectValue(obj);
          objectValue.Y = (int) Math.Round(num5 - (double) objectValue.Height / 2.0);
          num5 += num4;
        }
      }
      finally
    ...
    public virtual void GetObjectData(SerializationInfo info, StreamingContext context)
    {
      ...
      info.AddValue("Name", (object) this.mName);
      info.AddValue("Location", (object) this.mLocation);
      info.AddValue("Size", (object) this.mSize);
      info.AddValue("Parent", (object) this.mParent);
      info.AddValue("Comment", (object) this.mComment);
    }
    ...
    {
      this.mParent.mElements.Remove((object) this);
      this.mParent.mElements.Add((object) this);
    ...
    public void Reparent(GroupElement Parent)
    {
      if (this.mParent != null)
        this.UpdateParent -= new BaseElement.UpdateParentEventHandler(((BaseElement) this.mParent).RaiseUpdateEvent);
      this.mParent = Parent;
    }
