...
namespace GumpStudio
{
  public class LargeTextEditor : Form
  {
    ...
    {
      [DebuggerNonUserCode] get => this._cmdCancel;
    ...
    {
      [DebuggerNonUserCode] get => this._cmdOK;
      [DebuggerNonUserCode, MethodImpl(MethodImplOptions.Synchronized)] set
      {
    ...
    {
      [DebuggerNonUserCode] get => this._txtText;
      [DebuggerNonUserCode, MethodImpl(MethodImplOptions.Synchronized)] set => this._txtText = value;
    }

    public LargeTextEditor()
    {
      lock (LargeTextEditor.__ENCList)
        LargeTextEditor.__ENCList.Add(new WeakReference(this));
