...
namespace GumpStudio
{
    ...
    public class Settings : Form
    {
        ...
        internal virtual NumericUpDown NumericUpDown1
        {
            ...
            [DebuggerNonUserCode, MethodImpl( MethodImplOptions.Synchronized )]
            set => this._NumericUpDown1 = value;
        }
        ...
        internal virtual TrackBar TrackBar1
        {
            ...
            get => this._TrackBar1;
            [DebuggerNonUserCode, MethodImpl( MethodImplOptions.Synchronized )]
            set => this._TrackBar1 = value;
        }

        internal virtual TextBox txtClientPath
        {
            [DebuggerNonUserCode]
            get => this._txtClientPath;
            [DebuggerNonUserCode, MethodImpl( MethodImplOptions.Synchronized )]
            set => this._txtClientPath = value;
        }
        ...
        public Settings()
        {
            lock ( Settings.__ENCList )
                Settings.__ENCList.Add( new WeakReference( this ) );
