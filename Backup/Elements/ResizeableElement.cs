...
namespace GumpStudio.Elements
{
  ...
  public abstract class ResizeableElement : BaseElement
  {
    ...
    public override void DrawBoundingBox(Graphics Target, bool Active)
    {
      ...
      Target.FillRectangle(brush, bounds.X - 2, (int) Math.Round((double) bounds.Y + (double) bounds.Height / 2.0 - 2.0), 6, 6);
      Target.FillRectangle(brush, (int) Math.Round((double) bounds.X + (double) bounds.Width / 2.0 - 2.0), bounds.Y - 2, 6, 6);
      Target.FillRectangle(brush, bounds.X + bounds.Width - 3, (int) Math.Round((double) bounds.Y + (double) bounds.Height / 2.0 - 2.0), 6, 6);
      Target.FillRectangle(brush, (int) Math.Round((double) bounds.X + (double) bounds.Width / 2.0 - 2.0), bounds.Y + bounds.Height - 3, 6, 6);
      ...
      Target.DrawRectangle(pen, bounds.X - 2, (int) Math.Round((double) bounds.Y + (double) bounds.Height / 2.0 - 2.0), 6, 6);
      Target.DrawRectangle(pen, (int) Math.Round((double) bounds.X + (double) bounds.Width / 2.0 - 2.0), bounds.Y - 2, 6, 6);
      Target.DrawRectangle(pen, bounds.X + bounds.Width - 3, (int) Math.Round((double) bounds.Y + (double) bounds.Height / 2.0 - 2.0), 6, 6);
      Target.DrawRectangle(pen, (int) Math.Round((double) bounds.X + (double) bounds.Width / 2.0 - 2.0), bounds.Y + bounds.Height - 3, 6, 6);
      brush.Dispose();
      pen.Dispose();
    }
