...
namespace GumpStudio
{
  ...
  public class ClilocBrowser : Form
  {
    ...
    protected static ListBox ClilocCache = (ListBox) null;
    ...
    internal virtual ComboBox cboLanguage
    {
      [DebuggerNonUserCode] get
      {
        return this._cboLanguage;
      }
      [DebuggerNonUserCode, MethodImpl(MethodImplOptions.Synchronized)] set
      {
        this._cboLanguage = value;
      }
    }
    ...
    public ClilocBrowser()
    {
      ...
      lock (ClilocBrowser.__ENCList)
        ClilocBrowser.__ENCList.Add(new WeakReference((object) this));
    ...
    {
      foreach (string file in Directory.GetFiles(MySettings.Default.ClientPath, "Cliloc.*"))
        this.cboLanguage.Items.Add((object) Path.GetExtension(file).Substring(1));
    ...
    private void InitializeComponent()
    {
      ...
      this.Controls.Add((Control) this.cboLanguage);
      this.Controls.Add((Control) this.Label1);
      this.Controls.Add((Control) this.lstCliloc);
    ...
    private void lstCliloc_DrawItem(object sender, DrawItemEventArgs e)
    {
      ...
      e.DrawBackground();
      e.Graphics.DrawString(stringEntry.Number.ToString(), this.lstCliloc.Font, Brushes.Black, (float) e.Bounds.X, (float) e.Bounds.Top);
      e.Graphics.DrawString(stringEntry.Text.ToString(), this.lstCliloc.Font, Brushes.Black, (float) (e.Bounds.X + 100), (float) e.Bounds.Top);
    }
